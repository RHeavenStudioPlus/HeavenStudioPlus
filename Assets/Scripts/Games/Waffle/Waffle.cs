    ...
    public static class PcoWaffleLoader
    {
        public static Minigame AddGame(EventCaller eventCaller)
        {
            return new Minigame("fallingWaffle", "Falling Waffle", "ffffff", false, false, new List<GameAction>()
            {
                ...
                {
                    function = delegate { var e = eventCaller.currentEntity; Waffle.instance.broAlreadyFell(e.beat); },
                    defaultLength = 0.5f,
                },
                new GameAction("unfall", "Force Stand")
                {
                    function = delegate { var e = eventCaller.currentEntity; Waffle.instance.broGotUp(e.beat); },
                    defaultLength = 0.5f,
                },
...
namespace HeavenStudio.Games
{
    public class Waffle : Minigame
    {
        ...
        public void Flop(double beat)
        {
            ...
            else
            {
                ...
                BeatAction.New(instance, new List<BeatAction.Action>()
                {
                    ...
                    new BeatAction.Action(beat + 1, delegate { SoundByte.PlayOneShotGame("fallingWaffle/splat"); }),
                });
        ...
        public void broAlreadyFell(double beat)
        {
            HasFallen = true;
            waffleAnim.DoScaledAnimationAsync("IdleFlop", 0.5f);
        }

        public void broGotUp(double beat)
        {
            HasFallen = false;
